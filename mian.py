...
response_change_name_pokemon = requests.patch(url = f'{URL}/pokemons', headers = HEADER, json = body_change_name_pokemon)
print(response_change_name_pokemon.text)


body_add_pokemon_to_pokeball = {
    "pokemon_id": pokemon_id
    }

response_add_pokemon_to_pokeball = requests.post(url = f'{URL}/trainers/add_pokeball', headers = HEADER, json = body_add_pokemon_to_pokeball)
